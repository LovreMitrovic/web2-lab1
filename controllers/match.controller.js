const put = async (req, res) => {
    ...
    try {
        let match = await req.app.db.any(`SELECT matches.*, comp1.competitor_name AS name1, comp2.competitor_name AS name2, competitions.owner_email AS owner_email
                FROM matches
        ...
        match = match[0];
        if(match.owner_email !== req.oidc.user.email){
            console.log(match);
